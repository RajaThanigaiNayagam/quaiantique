...
<div class="container"><br><br><br><br>
    ...
    <div class="col-md-12">
        <h3 class="text-center  menuSubTitle">MENU DU MARCHÉ<br></h3>
        <?php 
        ...
        <div class="container-fluid">';
            ...
            if ($menuresult->num_rows > 0) {    
                while($menurow = $menuresult->fetch_assoc()) {
                    ...
                    $sql = "SELECT m.image AS menuimage, m.name AS menuname, m.price AS menuprice, m.menusession AS menusession, f.name AS foodname, c.name as categoryname  FROM menu AS m INNER JOIN menu_foods AS mf ON mf.menu_id = m.Id INNER JOIN foods AS f ON mf.food_id=f.Id INNER JOIN category AS c ON f.category_id = c.Id WHERE m.Id=$menuid" ;
                    //$sql = "SELECT * FORM menu";menusession
                    $counterstarter=0;
                    $counterburger=0;
                    $countermaincourse=0;
                    $counterdessert=0;
                    ...
                    $menusession=$menurow['menusession'];
                    ...
                    <section id="home">
                        <div  class="row">
                            <div class="col-lg-6 col-md-6 col-12 order-1 pt-5">
                                <h1 class="display-5 menuSubTitle">' . $menuname . '</span> </h1>
                                <h5 class="display-5 menusession">' . $menusession . '</span> </h5>';
                                if ( $counterstarter > 0 ) {
