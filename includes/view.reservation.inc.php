...
if(isset($_SESSION['user_id'])){
    ...
    if ($result->num_rows > 0) {
        echo'
        <p class="text-white bg-dark text-center">'. $_SESSION['username'] .', ici, vous pouvez consulter l\'historique de vos réservations</p><br>
    ...
    if ($result->num_rows > 0) {
        echo'
        <p class="text-white bg-dark text-center">Ici, vous pouvez consulter l\'historique de toutes les réservations de tous les utilisateurs.</p><br>
        <table class="table table-hover table-responsive-sm text-center">
            <thead>
                <tr>
                    <th scope="col" class="schedulehour">Nom et prénom</th>
